...
export const Header: React.FC<HeaderProps> = ({ isDarkMode = true, onAvatarClick }) => {
  return (
      ...
      <div className="w-full flex justify-end items-center mb-0">
        <div className="relative">
          <img 
            ...
            className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full object-cover border-2 shadow-xl cursor-pointer ${isDarkMode ? 'border-white/20' : 'border-black/10'}`}
